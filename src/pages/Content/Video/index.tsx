...
const TableList: React.FC = () => {
  ...
  const columns: ProColumns<API.ItemData>[] = [
    ...
    {
      title: intl.formatMessage({ id: 'videoUrl', defaultMessage: '视频' }),
      dataIndex: 'url',
      hideInSearch: true,
      render: (dom: React.ReactNode, entity: API.ItemData) => (
        <VideoPlayer entity={entity} videoUrl={entity.url} />
      ),
    },
    {
