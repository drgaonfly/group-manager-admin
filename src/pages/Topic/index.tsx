...
const handleUpdate = async (fields: FormValueType) => {
  ...
  try {
    await updateItem(`/topics/${fields._id}`, fields);
    hide();
  ...
  return (
    <PageContainer>
      <ProTable<API.ItemData, API.PageParams>
        ...
        request={async (params, sort, filter) => queryList('/topics', params, sort, filter)}
        columns={columns}
        rowSelection={
          access.canSuperAdmin && {
