...
const handleAdd = async (fields: API.ItemData) => {
  ...
  try {
    await addItem('/depth-incomes', { ...fields });
    hide();
...
const handleUpdate = async (fields: FormValueType) => {
  ...
  try {
    await updateItem(`/depth-incomes/${fields._id}`, fields);
    hide();
...
const handleRemove = async (ids: string[]) => {
  ...
  if (!ids) return true;
  try {
    await removeItem('/depth-incomes', {
      ids,
    });
    hide();
...
const TableList: React.FC = () => {
  ...
  const columns: ProColumns<API.ItemData>[] = [
    ...
    {
      title: intl.formatMessage({ id: 'incomeRate' }),
  ...
  return (
    <PageContainer>
      <ProTable<API.ItemData, API.PageParams>
        ...
        request={async (params, sort, filter) => queryList('/depth-incomes', params, sort, filter)}
        columns={columns}
        rowSelection={
