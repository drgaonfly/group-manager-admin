...
import { Modal, Button, Table, Space, message, Tag, Dropdown } from 'antd';
...
const AuctionRuleGroupModal: React.FC<Props> = ({ open, onClose, bot, group }) => {
...
export default AuctionRuleGroupModal;
