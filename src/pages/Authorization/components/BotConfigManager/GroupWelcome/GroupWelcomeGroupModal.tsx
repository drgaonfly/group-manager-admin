...
import { Modal, Button, Table, Space, message, Popconfirm, Tag } from 'antd';
...
const GroupWelcomeGroupModal: React.FC<Props> = ({ open, onClose, bot, group }) => {
  ...
  return (
    <>
      ...
      {/* GroupWelcomeForm：编辑时传 editingRecord，新建时传 fixedGroupId */}
      <GroupWelcomeForm
        open={formOpen}
...
export default GroupWelcomeGroupModal;
