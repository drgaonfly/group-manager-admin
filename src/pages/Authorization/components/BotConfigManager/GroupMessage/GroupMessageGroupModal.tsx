...
import { Modal, Button, Table, Space, Switch, message, Popconfirm } from 'antd';
...
const GroupMessageGroupModal: React.FC<Props> = ({ open, onClose, bot, group }) => {
...
export default GroupMessageGroupModal;
