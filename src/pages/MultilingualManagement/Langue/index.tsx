...
const handleUpdate = async (fields: FormValueType) => {
  ...
  try {
    await updateItem(`/langues/${fields._id}`, fields);
    hide();
...
const TableList: React.FC = () => {
  ...
  const columns: ProColumns<API.ItemData>[] = [
    {
      title: intl.formatMessage({ id: 'langue.image' }),
      dataIndex: 'image',
      hideInSearch: true,
      valueType: 'image',
      render: (_, record) => (
    ...
    {
      title: intl.formatMessage({ id: 'langue.code' }),
      dataIndex: 'code',
      hideInSearch: false,
      copyable: true,
      width: '15%',
    ...
    {
      title: intl.formatMessage({ id: 'langue.name' }),
      dataIndex: 'name',
      hideInSearch: false,
      copyable: true,
      width: '15%',
    ...
    {
      title: intl.formatMessage({ id: 'langue.title' }),
      dataIndex: 'title',
      hideInSearch: false,
      copyable: true,
      width: '15%',
    ...
    {
      title: intl.formatMessage({ id: 'langue.isDefault' }),
      dataIndex: 'isDefault',
      hideInSearch: false,
      valueType: 'switch',
      width: '10%',
  ...
  return (
    <PageContainer>
      <ProTable<API.ItemData, API.PageParams>
        ...
        request={async (params, sort, filter) => queryList('/langues', params, sort, filter)}
        columns={columns}
        rowSelection={
          access.canSuperAdmin && {
