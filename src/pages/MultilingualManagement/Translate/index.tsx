...
const handleAdd = async (fields: API.ItemData) => {
  ...
  try {
    await addItem('/translates', { ...fields });
    hide();
...
const handleUpdate = async (fields: FormValueType) => {
  ...
  try {
    await updateItem(`/translates/${fields._id}`, fields);
    hide();
...
const TableList: React.FC = () => {
  ...
  const columns: ProColumns<API.ItemData>[] = [
    {
      title: <FormattedMessage id="pages.searchTable.translate" defaultMessage="Translate" />,
      dataIndex: 'translate',
      key: 'translate',
    },
    {
      title: <FormattedMessage id="pages.searchTable.langue" defaultMessage="Language" />,
      dataIndex: 'langue',
      key: 'langue',
      valueType: 'select',
    },
  ...
  return (
    <PageContainer>
      <ProTable<API.ItemData, API.PageParams>
        ...
        toolbar={{}}
        request={async (params, sort, filter) => queryList('/translates', params, sort, filter)}
        columns={columns}
        rowSelection={
