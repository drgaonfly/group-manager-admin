...
const handleAdd = async (fields: API.ItemData) => {
  ...
  try {
    await addItem('/lottery-records', { ...fields });
    hide();
...
const handleUpdate = async (fields: FormValueType) => {
  ...
  try {
    await updateItem(`/lottery-records/${fields._id}`, fields);
    hide();
...
const handleRemove = async (ids: string[]) => {
  ...
  if (!ids) return true;
  try {
    await removeItem('/lottery-records', {
      ids,
    });
    hide();
    message.success(
...
const TableList: React.FC = () => {
  ...
  const columns: ProColumns<API.ItemData>[] = [
    ...
    {
      title: intl.formatMessage({ id: 'usdt' }),
      dataIndex: 'usdt',
    },
    {
      title: intl.formatMessage({ id: 'beInviteds' }),
      dataIndex: 'beInviteds',
    },
    {
      title: intl.formatMessage({ id: 'toInvites' }),
      dataIndex: 'toInvites',
    },
    {
    ...
    <PageContainer>
      <ProTable<API.ItemData, API.PageParams>
        ...
        request={async (params, sort, filter) =>
          queryList('/lottery-records', { ...params, isOnline: activeKey }, sort, filter)
        }
        columns={columns}
        rowSelection={
          access.canSuperAdmin && {
