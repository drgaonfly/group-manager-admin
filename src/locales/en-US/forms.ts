export default {
  ...
  issue: 'Issue',
  'issue.normal': 'Normal',
  'issue.unfriendly': 'Unfriendly',
  'issue.recogError': 'Recognition Error',
  'issue.videoError': 'Video Error',
  'pages.comment.answer': 'Answer Name',
  'menu.topic': 'Topic management',
  video: 'Video',
  name: 'Name',
  'menu.topics': 'Topic management',
  'pages.comment.user': 'User',
  'pages.comment.topic': 'Topic',
  ...
  'menu.list.proxies': 'proxy list',
  'menu.list.employee': 'employee list',
  'menu.员工管理': 'Employee Management',
  'menu.代理管理': 'Proxy Management',
  'menu.答案管理': 'Answer Management',
  'menu.新手训练': 'Newbie Training',
  'menu.记录管理': 'Record Management',
  'menu.list.employees': 'Employee List',
  answer: 'Answer',
