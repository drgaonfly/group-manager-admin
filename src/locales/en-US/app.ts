export default {
  ...
  enter_action: 'Please Enter Action',
  name: 'Name',
  parent: 'Parent',
  ...
  '2fa.disabled.success': 'Two-factor authentication has been disabled successfully',
  'disable.2fa.title': 'Disable Two-Factor Authentication',
  'security.warning': 'Security Warning',
  'disable.2fa.warning':
    'Disabling two-factor authentication will reduce account security. Only proceed if you cannot access your authenticator.',
  'current.password': 'Current Password',
  'please.enter.password': 'Please enter your login password',
  'enter.password.confirm': 'Enter account password to confirm identity',
  'verification.code.or.backup': 'Verification Code or Backup Code',
  'please.enter.verification.code': 'Please enter current 6-digit code or backup code',
  'invalid.code.format': 'Invalid format',
  'enter.verification.or.backup': 'Enter 6-digit code or 8-digit backup code',
  '2fa.settings.title': 'Two-Factor Authentication Settings',
