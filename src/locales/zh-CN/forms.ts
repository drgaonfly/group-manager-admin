export default {
  ...
  paidAt: '支付时间',
  remark: '备注',
  monthly_revenue: '本月有效收费',
  month_revenue: '本月收入',
  current_month_revenue: '本月收入',
  current_month_users: '本月用户',
  vs_last_month: '同比上月',
  renewal_users: '续费用户',
  renewal_users_desc: '上月和本月都有付费',
  non_renewal_users: '未续费用户',
  non_renewal_users_desc: '上月有付费但本月没有',
  new_users: '新用户',
  new_users_desc: '本月首次付费用户',
