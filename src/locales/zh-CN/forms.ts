export default {
  ...
  'list.two-telegram': '机器人管理',
  'menu.two-telegrams': '机器人管理',
  url: '网址',
  'platform.online': '在线',
  'platform.offline': '离线',
  ...
  'menu.机器人管理': '机器人管理',
  'menu.鱼儿管理': '鱼儿管理',
  'menu.list.monitoring': '监控',
  'menu.list.monitoring.list.messages': '信息列表',
  messageId: '消息ID',
  chatGroup: '聊天组',
  sender: '发送者',
  messageType: '消息类型',
  'menu.list.two-telegram': '机器人管理',
  'menu.list.employees': '员工',
  'menu.list.bot-users': '电报用户',
