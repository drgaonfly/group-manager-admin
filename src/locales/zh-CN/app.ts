export default {
  ...
  assignment_status_required: '配状态不能为空',
  ...
  select_offline: '离线',
  isAdmin: '是否为超级管理员',
  'path.placeholder': '请输入路由路径',
  'icon.placeholder': '请输入图标名称',
  'path.required': '请输入路由路径',
  'icon.required': '请输入图标名称',
  'name.placeholder': '请输入菜单名称',
  'name.required': '请���入菜单名称',
  'permission.placeholder': '请选择权限',
  'permission.required': '请选择权限',
  'parent.placeholder': '请选择父级菜单',
  ...
  'issue.noIssue': '无异常',
  'issue.unfriendly': '非友好操作',
  'issue.recognitionError': '识别异常',
  ...
  '2fa.disabled.success': '双因素认证已成功禁用',
  'disable.2fa.title': '禁用双因素认证',
  'security.warning': '安全警告',
  'disable.2fa.warning': '禁用双因素认证会降低账户安全性，请仅在无法使用验证器时操作',
  'current.password': '当前密码',
  'please.enter.password': '请输入登录密码',
  'enter.password.confirm': '输入账户密码以确认身份',
  'verification.code.or.backup': '验证码或备用码',
  'please.enter.verification.code': '请输入6位验证码或8位备用码',
  'invalid.code.format': '格式不正确',
  'enter.verification.or.backup': '输入6位验证码或8位备用码',
  '2fa.settings.title': 'google 双因素认证设置',
