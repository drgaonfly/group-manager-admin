export default {
  ...
  'pages.role.addFail': '添加失败，请重试!',
  'pages.role.updating': '正在更新',
  'pages.role.updateSuccess': '更新成功',
  'pages.role.updateFail': '更新失败，请重试!',
  'pages.role.deleting': '正在删除',
  ...
  'pages.role.items': '项',
  'pages.role.confirmDelete': '确认删除?',
  'pages.role.deleteConfirm': '确定要删除吗?',
  'pages.role.confirm': '确认',
  'pages.role.cancel': '取消',
  'pages.role.batchDeletion': '批量删除',
  'pages.bills.list': '账单列表',
  'pages.bills.amount': '金额',
  'pages.bills.amount.placeholder': '请输入金额',
  'pages.bills.type': '类型',
  'pages.bills.type.placeholder': '请选择类型',
  'pages.bills.income': '收入',
  'pages.bills.expense': '支出',
  'pages.bills.description': '描述',
  'pages.bills.description.placeholder': '请输入描述',
  'pages.bills.createTime': '创建时间',
  'pages.bills.new': '新建账单',
  'pages.bills.edit': '编辑',
  'pages.bills.delete': '删除',
  'pages.bills.confirm': '确认',
  'pages.bills.cancel': '取消',
  'pages.bills.confirmDelete': '确认删除',
  'pages.bills.confirmDeleteContent': '确定要删除这条记录吗？',
  'pages.bills.selectCategory': '请选择分类',
  'pages.bills.chosen': '已选择',
  'pages.bills.item': '项',
