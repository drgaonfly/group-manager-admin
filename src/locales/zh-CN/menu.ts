export default {
  ...
  'menu.list': '列表页',
  'menu.users': '用户',
  'menu.materialCategories': '材料类目',
  'menu.bills': '账单',
  'menu.emptyPackages': '空包',
  'menu.account-library': '账号库',
  'menu.empty-packages': '空包',
  'menu.list.user': '用户',
  'menu.list.change-password': '修改密码',
  'menu.list.newbie_training': '新手训练',
  ...
  'menu.newbie-training': '新手训练',
  'menu.newbieTraining': '新手训练',
  'menu.editor': '图形编辑器',
  ...
  'menu.答案管理': '答案管理',
  'menu.记录管理': '记录管理',
  'menu.list.record': '记录管理',
  'menu.list.topic': '主题管理',
  'menu.list.newbie-training': '新手训练',
  'tabs.close.left': '关闭左侧标签页',
  'tabs.close.right': '关闭右侧标签页',
  'tabs.close.others': '关闭其他标签页',
  'tabs.refresh': '刷新当前页面',
  'menu.list.withdraws': '提现',
  'menu.withdraws': '提现管理',
  'menu.usage-instructions': '使用说明',
};
