export default {
  ...
  'app.setting.content-width.fluid': 'Lỏng',
  ...
  'app.setting.themecolor.green': 'Xanh lục bắc cực',
  'app.setting.themecolor.daybreak': 'Xanh dương bình minh (mặc định)',
  'app.setting.themecolor.geekblue': 'Xanh dương geek',
  ...
  'app.setting.hideheader.hint': 'Hoạt động khi Ẩn tiêu đề được bật',
  'app.setting.othersettings': 'Cài đặt khác',
  'app.setting.weakmode': 'Chế độ thân thiện với màu mù',
